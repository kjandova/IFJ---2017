    ...
    switch(flag){
        ...
        case TOKEN_ADD:
            if(item1->dataType == DATA_TYPE_STRING){
                instruct = I_CONCAT;
                generateInstruction(__parser_function->commands, instruct, item1, item1, item2);
            }
        ...
        case TOKEN_NON_EQUAL:
            instruct = I_NOT;
            generateInstruction(__parser_function->commands, instruct, item1, item2, NULL);
        break;
        ...
        switch(precedence){
            ...
            case '<':
                ...
                if((run == 1) && ((b.flag == TOKEN_END_OF_LINE) || (b.flag == TOKEN_THEN))){
                    ...
                    generateInstruction(__parser_function->commands, I_MOVE, _return, a->last->prem, NULL);
                    delete_list(a);
                    return SUCCESS;
                }
            ...
            case 'E':
                ...
                generateInstruction(__parser_function->commands, I_MOVE, _return, a->startExp->prem, NULL);
